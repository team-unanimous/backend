...
public class EmailService {
    ...
    //팀 참가시 UUID 보내기
//    public ResponseEntity teamEmailSend(TeamEmailRequestDto teamEmailRequestDto) {
//        Properties props = new Properties();
//        props.put("mail.smtp.host", "smtp.naver.com");
//        props.put("mail.smtp.port", 465);
//        props.put("mail.smtp.auth", "true");
...
//
//        List<EmailRequestDto> teamEmailRequestDtos = teamEmailRequestDto.getEmailRequestDtoList();
//        System.out.println(teamEmailRequestDtos);
//        for (EmailRequestDto teamUsername : teamEmailRequestDtos) {
//            String username = teamUsername.getUsername();
//            System.out.println(username);
//            try {
////                String uuid = teamRepository.findByUuid();
//                Message mimeMessage = new MimeMessage(session);
//                mimeMessage.setFrom(new InternetAddress(email, nickName));        // 별명 설정
